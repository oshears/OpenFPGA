...
def gen_4x4_designs(NUM_DESIGNS=1, route_chan_width=4):

    NUM_LUTS = 4*4*4 - 4
    SIZE= "4x4"

    dir_name = "openfpga__arch_4x4__tiered_luts__20240520"
    ...
    make_tiered_il_designs(design_dir, 4, NUM_DESIGNS, NUM_LUTS=NUM_LUTS)
...
def analyze_designs(VERTICAL_CLB_COUNT, NUM_DESIGNS, dataset_name=None, overwrite=False, load=True):
    ...
    dir_name = "openfpga__arch_4x4__windows_1__partitions_400__tiered_luts__20240517"
    ...
    # output_dir = f"debug/architectures/arch_gen/results/openfpga__arch_6x6__lut_140__tiered_luts__2024049"
    ...
    # validate_windows(module_layout_grid, windows_4x4)
...
if __name__ == "__main__":
    ...
    gen_4x4_designs(10, route_chan_width=16)
    # analyze_designs(VERTICAL_CLB_COUNT=4, NUM_DESIGNS=50)
